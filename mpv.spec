...
Version  : 0.35.0
Release  : 39
URL      : https://github.com/mpv-player/mpv/archive/v0.35.0/mpv-0.35.0.tar.gz
Source0  : https://github.com/mpv-player/mpv/archive/v0.35.0/mpv-0.35.0.tar.gz
...
%prep
%setup -q -n mpv-0.35.0
cd %{_builddir}/mpv-0.35.0
%patch1 -p1
%patch2 -p1
pushd ..
cp -a mpv-0.35.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668624999
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/glibc-hwcaps/x86-64-v3/libmpv.so.2
/usr/lib64/glibc-hwcaps/x86-64-v3/libmpv.so.2.0.0
