...
Version  : 0.34.0
Release  : 24
URL      : https://github.com/mpv-player/mpv/archive/v0.34.0/mpv-0.34.0.tar.gz
Source0  : https://github.com/mpv-player/mpv/archive/v0.34.0/mpv-0.34.0.tar.gz
...
%prep
%setup -q -n mpv-0.34.0
cd %{_builddir}/mpv-0.34.0
%patch1 -p1
%patch2 -p1
pushd ..
cp -a mpv-0.34.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636486836
...
cp %{_builddir}/mpv-0.34.0/LICENSE.GPL %{buildroot}/usr/share/package-licenses/mpv/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/mpv-0.34.0/LICENSE.LGPL %{buildroot}/usr/share/package-licenses/mpv/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../buildavx2/
%make_install_v3
popd
%make_install
